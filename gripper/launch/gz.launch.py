...
def generate_launch_description():
    pkg_path = get_package_share_directory('gripper')
    urdf_path = os.path.join(pkg_path, 'urdf', 'robot_arm.urdf.xacro')

    # --- FIX STARTS HERE ---
    # We need to tell Gazebo where the "robot_arm" package is located.
    # get_package_share_directory returns: .../install/robot_arm/share/robot_arm
    # We need the PARENT directory: .../install/robot_arm/share
